...
full_comparison_DF.createOrReplaceTempView('tprices')
...
# MAGIC %sql
# MAGIC SELECT pub_date, 
# MAGIC   COUNT(*) AS total_prices,
# MAGIC   SUM(CASE price_match WHEN 'True' THEN 1 ELSE 0 END) AS price_match,
# MAGIC   SUM(CASE price_match WHEN 'True (rounding diff)' THEN 1 ELSE 0 END) AS price_rounding_diff,
# MAGIC   SUM(CASE price_match WHEN 'False' THEN 1 ELSE 0 END) AS price_mismatch,
# MAGIC   SUM(CASE )
# MAGIC FROM tprices
# MAGIC GROUP BY pub_date
